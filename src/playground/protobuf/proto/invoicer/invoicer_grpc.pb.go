...
type InvoicerClient interface {
	Creat(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error)
...
func (c *invoicerClient) Creat(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, "/Invoicer/Creat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *invoicerClient) Update(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	out := new(CreateResponse)
	err := c.cc.Invoke(ctx, "/Invoicer/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InvoicerServer interface {
	Creat(context.Context, *CreateRequest) (*CreateResponse, error)
...
func (UnimplementedInvoicerServer) Creat(context.Context, *CreateRequest) (*CreateResponse, error) {
...
func _Invoicer_Creat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InvoicerServer).Creat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Invoicer/Creat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoicerServer).Creat(ctx, req.(*CreateRequest))
	}
...
var Invoicer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Creat",
			Handler:    _Invoicer_Creat_Handler,
		},
		{
			MethodName: "Update",
